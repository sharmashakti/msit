...
namespace StatlerWaldorfCorp.EventProcessor.Location.Redis
{
    public class RedisLocationCache : ILocationCache
    {
        ...
        private StackExchange.Redis.IConnectionMultiplexer connection;
        ...
        private IList<MemberLocation> ConvertRedisValsToLocationList(StackExchange.Redis.RedisValue[] vals)
        {
